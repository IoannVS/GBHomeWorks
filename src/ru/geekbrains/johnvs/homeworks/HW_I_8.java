...
class Robot{
    ...
    /**
     * Метод позволяет перепрыгнуть стену с заданной высотой. Выводит в консоль сообщение о результатах прыжка
...
class Wall {
    ...
    /**
     * Метод прыжка: сравниваем высоту стены и максимальную высоту прыжка существа, которое пробует перепрыгнуть стену
